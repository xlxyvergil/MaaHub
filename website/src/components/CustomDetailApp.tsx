...
export function CustomDetailApp({ customId, customData, lang = 'zh' }: { customId: string, customData: any, lang?: 'zh' | 'en' }) {
  ...
  const handleCopy = () => {
    ...
    navigator.clipboard.writeText(`git clone https://github.com/MaaXYZ/MaaHub.git --depth=1\ncp -r MaaHub/Storage/customs/${customData.author}/${customData.id.split('/')[1]} ./your_agent_customs/`);
    setIsCopied(true);
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-6">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span>{customData.downloads || 0}</span>
                  </div>
                </div>
                ...
                <div className="rounded-lg border bg-card p-4 shadow-sm">
                  ...
                  <div className="relative">
                    <pre className="overflow-x-auto rounded bg-muted p-3 text-xs font-mono">
                      <code>MaaHub install custom {customData.id}</code>
                    </pre>
                    <button 
                      onClick={handleCopy}
